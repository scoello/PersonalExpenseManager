...
- I used Codex to support the implementation process.
- I added a `GenAI` folder to the repository containing the prompts used during the exercise and the files initially generated by the AI.
- I reviewed and validated the AI-generated suggestions using my software development experience rather than accepting them without verification.
- During my review, I identified that the initial generated application did not fully align with the architecture and requirements of the exercise. Given the available time, I prioritized delivering the core functionality instead of performing a complete architectural refactor.
- My usual workflow when using AI-assisted development tools is iterative: I review the generated output, request the required architectural changes, inspect and understand the resulting code, ask for clarification when necessary, and perform any additional refactoring needed to meet the project's standards.

## Final Note

I used Codex as a supporting tool while developing this exercise, following the AI-assisted workflow described above. I reviewed, understood, and validated the generated output, and I remained responsible for the final technical decisions and implementation.